...
const LANGS = {
  id: {
    ...
    skillCat1: 'PEMROGRAMAN', skillCat2: 'TRADING & ALGO', skillCat3: 'INFRASTRUKTUR & DEVOPS', skillCat4: 'TOOLS & STACK', skillCat5: 'MACHINE LEARNING', skillCat6: 'DATA SCIENCE & LIBRARIES',
  ...
  en: {
    ...
    skillCat1: 'PROGRAMMING', skillCat2: 'TRADING & ALGO', skillCat3: 'INFRASTRUCTURE & DEVOPS', skillCat4: 'TOOLS & STACK', skillCat5: 'MACHINE LEARNING', skillCat6: 'DATA SCIENCE & LIBRARIES',
  ...
  ja: {
    ...
    skillCat1: 'プログラミング', skillCat2: 'トレード & アルゴ', skillCat3: 'インフラ & DevOps', skillCat4: 'ツール & スタック', skillCat5: '機械学習', skillCat6: 'データサイエンス & ライブラリ',
  ...
  ko: {
    ...
    skillCat1: '프로그래밍', skillCat2: '트레이딩 & 알고', skillCat3: '인프라 & DevOps', skillCat4: '툴 & 스택', skillCat5: '머신러닝', skillCat6: '데이터 사이언스 & 라이브러리',
  ...
  es: {
    ...
    skillCat1: 'PROGRAMACIÓN', skillCat2: 'TRADING & ALGO', skillCat3: 'INFRAESTRUCTURA & DEVOPS', skillCat4: 'HERRAMIENTAS & STACK', skillCat5: 'MACHINE LEARNING', skillCat6: 'CIENCIA DE DATOS & LIBRERÍAS',
  ...
  ar: {
    ...
    skillCat1: 'البرمجة', skillCat2: 'التداول والخوارزميات', skillCat3: 'البنية التحتية والتطوير', skillCat4: 'الأدوات والتقنيات', skillCat5: 'التعلم الآلي', skillCat6: 'علم البيانات والمكتبات',
  ...
  zh: {
    ...
    skillCat1: '编程', skillCat2: '交易与算法', skillCat3: '基础设施与运维', skillCat4: '工具与技术栈', skillCat5: '机器学习', skillCat6: '数据科学与库',
