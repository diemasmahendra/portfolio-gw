...
const LANGS = {
  id: {
    ...
    navProjects: 'Proyek', navProjectsDesc: '20 proyek',
  ...
  en: {
    ...
    navProjects: 'Projects', navProjectsDesc: '20 projects',
  ...
  ja: {
    ...
    navProjects: 'プロジェクト', navProjectsDesc: '20件',
  ...
  ko: {
    ...
    navProjects: '프로젝트', navProjectsDesc: '20개 프로젝트',
  ...
  es: {
    ...
    navProjects: 'Proyectos', navProjectsDesc: '20 proyectos',
  ...
  ar: {
    ...
    navProjects: 'مشاريع', navProjectsDesc: '20 مشروعاً',
  ...
  zh: {
    ...
    navProjects: '项目', navProjectsDesc: '20个项目',
